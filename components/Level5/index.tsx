...
import ComponentStateProviderRaw from "!!raw-loader!./ComponentStateProvider.tsx";
...
import ContainerRaw from "!!raw-loader!./Container/index.tsx";
...
const Level1 = () => (
  <CodeList>
    <TabList>
      ...
      <Tab title="<ComponentStateProvider />">
        <Code>{ComponentStateProviderRaw}</Code>
      </Tab>
    </TabList>
  </CodeList>
);
